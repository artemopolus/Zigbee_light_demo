...
#define MLine_SCL_PIN                         (11U)
#define MLine_SCL_PORT                        (gpioPortC)
#define MLine_SCL_LOC                         (15U)

#define BSP_I2C0_SDA_PIN                      (10U)
#define BSP_I2C0_SDA_PORT                     (gpioPortC)
#define BSP_I2C0_SDA_LOC                      (15U)
#define MLine_SDA_PIN                         (10U)
#define MLine_SDA_PORT                        (gpioPortC)
#define MLine_SDA_LOC                         (15U)

#define HAL_I2C0_INIT_ENABLE                  (1)
#define HAL_I2C0_LOW_HIGH_RATIO               (_I2C_CTRL_CLHR_STANDARD)
#define HAL_I2C0_MASTER                       (0)
#define HAL_I2C0_SLAVE_ADDRESS                (77U)
#define MLine_INIT_ENABLE                     (1)
#define MLine_LOW_HIGH_RATIO                  (_I2C_CTRL_CLHR_STANDARD)
#define MLine_MASTER                          (0)
#define MLine_SLAVE_ADDRESS                   (77U)
// [I2C0]$
...
#define BSP_IOEXP_WAKE_PIN                    (6U)
#define BSP_IOEXP_WAKE_PORT                   (gpioPortF)

#define HAL_IOEXP_VCOM_ENABLE                 (0)
...
#define HAL_IOEXP_INIT_ENABLE                 (1)
#define HAL_IOEXP_LOW_HIGH_RATIO              (_I2C_CTRL_CLHR_STANDARD)
#define HAL_IOEXP_MASTER                      (0)
// [IOEXP]$
...
#define HAL_SERIAL_APP_FLOW_CONTROL           (HAL_USART_FLOW_CONTROL_SW)
