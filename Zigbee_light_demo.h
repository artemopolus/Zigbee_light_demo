...
#define EM_AF_GENERATED_NETWORK_STRINGS  \
  "Primary (pro)", \
/**** ZCL Section ****/
#define ZA_PROMPT "Zigbee_light_demo"
...
/**** Optional Attributes ****/
#define ZCL_USING_IAS_ZONE_CLUSTER_IAS_ZONE_CLUSTER_REPORTING_STATUS_SERVER_ATTRIBUTE 
...
#define EMBER_AF_API_ADC_CORTEXM3 "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/adc/adc-cortexm3.h"

// API adc from ADC plugin
#define EMBER_AF_API_ADC "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/adc/adc.h"

// API antenna from Antenna Stub plugin
#define EMBER_AF_API_ANTENNA "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/antenna/antenna.h"

// API button-interface from Button Interface plugin
#define EMBER_AF_API_BUTTON_INTERFACE "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/util/plugin/plugin-common/button-interface/button-interface.h"

// API coexistence from Radio Coexistence Stub plugin
#define EMBER_AF_API_COEXISTENCE "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/platform/radio/rail_lib/plugin/coexistence/protocol/ieee802154/coexistence-802154.h"

// API find-and-bind-target from Find and Bind Target plugin
#define EMBER_AF_API_FIND_AND_BIND_TARGET "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/find-and-bind-target/find-and-bind-target.h"

// API generic-interrupt-control from Generic GPIO Interrupt Controller plugin
#define EMBER_AF_API_GENERIC_INTERRUPT_CONTROL "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/util/plugin/plugin-common/generic-interrupt-control/generic-interrupt-control.h"

// API gpio-sensor from GPIO Sensor Interface plugin
#define EMBER_AF_API_GPIO_SENSOR "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/util/plugin/plugin-common/gpio-sensor/gpio-sensor.h"

// API i2c-driver from I2C Driver plugin
#define EMBER_AF_API_I2C_DRIVER "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/i2c-driver/i2c-driver.h"

// API network-steering from Network Steering plugin
#define EMBER_AF_API_NETWORK_STEERING "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/network-steering/network-steering.h"

// API rail-library from RAIL Library plugin
#define EMBER_AF_API_RAIL_LIBRARY "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/platform/radio/rail_lib/common/rail.h"

// API scan-dispatch from Scan Dispatch plugin
#define EMBER_AF_API_SCAN_DISPATCH "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/scan-dispatch/scan-dispatch.h"

// API serial from Serial plugin
#define EMBER_AF_API_SERIAL "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/serial/serial.h"

// API update-tc-link-key from Update TC Link Key plugin
#define EMBER_AF_API_UPDATE_TC_LINK_KEY "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/update-tc-link-key/update-tc-link-key.h"

// API command-interpreter2 from ZCL Framework Core plugin
#define EMBER_AF_API_COMMAND_INTERPRETER2 "../../../Soft/Simplicity/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/util/serial/command-interpreter2.h"
